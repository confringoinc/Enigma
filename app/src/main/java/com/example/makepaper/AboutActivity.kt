...
import kotlinx.android.synthetic.main.activity_edit_paper.btn_back
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_about_site.setOnClickListener {
            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse("http://www.confringoinc.github.io/enigma"))
