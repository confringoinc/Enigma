...
class LastQuestionAdapter(val context: Context?, private var questions: MutableList<Questions>) :
    RecyclerView.Adapter<LastQuestionAdapter.MyViewHolder>() {
            ...
            itemView.ib_options.setOnClickListener {
                ...
                popup.setOnMenuItemClickListener { item ->
                    when (item.title) {
                        "Edit" -> {
                            val query: Query =
                                databaseReference.child(question.paperkey!!).child("questions")
                                    .orderByChild("question").equalTo(
                                        question.question
                                    )
                            ...
                            Dialog(context!!)
                                .apply {
                                    ...
                                    btnDelete.setOnClickListener {
                                        ...
                                        val query: Query =
                                            databaseReference.child(question.paperkey!!)
                                                .child("questions").orderByChild("question")
                                                .equalTo(
                                                    question.question
                                                )
